  ...
  return (
    <div className="md:mx-8 mt-12 py-12">
        ...
        <div className="flex justify-between p-4">
            <div className="basis-[45%] md:text-right text-black md:text-xl md:leading-loose">
               <p className="py-5">AUGUST 2021 - PRESENT</p>
               <p className="py-5">AUGUST 2021 - PRESENT</p>
               <p className="py-5">AUGUST 2021 - PRESENT</p>
               <p className="py-5">AUGUST 2021 - PRESENT</p>
            </div>
            <div className="basis-6/12 text-black md:text-xl md:leading-loose font-semibold">
                <hr/>
                <div className="flex flex-col md:flex-row md:justify-between py-5 border border-t-black">
                    <p>Crop2Cash</p>
